...
if __name__ == "__main__":
    ...
    url = "https://github.com/openworm/c302/blob/master/examples/c302_C_Full.net.nml#L%i"
    ...
    for cell in sorted(ads.keys()):
        ...
        i = 0
        search_file = open(
            os.path.normpath(os.path.join(currentfile_dir, "..", "examples", "c302_C_Full.net.nml")), "r"
        )
